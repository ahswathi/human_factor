  ...
  return (
    <div className="main relative bg-[#FFFFFF] relative w-[375px] 2xl:w-[1920px] h-[1618.5px] 2xl:w-[1665px] ">
        ...
        2xl:w-[428px] 2xl:h-[4px]"></div>
          ...
          <div className="absolute  w-[220px] h-[50px] left-[18px]
          2xl:w-[440px] 2xl:h-[98px] 	2xl:top-[805px] 2xl:left-[1076px]">
            <div className="absolute w-[220px] h-[22px] top-[645px] 2xl:w-[440px] 2xl:h-[43px] flex items-center 2xl:text-[32px] text-[#1A1A1A] opacity-[.6]
            font-medium 2xl:text-[32px] 2xl:top-[5px] 2xl:leading-[21.6px]">
            Or Email Us At
            </div>
              <div className="absolute  w-[189px] h-[24px]  top-[668px] 2xl:w-[378px] 2xl:h-[48px] flex flex-row items-center 	2xl:top-[50px] text-[#1A1A1A]">
